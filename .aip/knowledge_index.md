...
| K-003 | deployment | active | Claude Code 的项目级技能目录 `<repo>/.claude/skills/`；升级到 0.3.0 的任何老仓库都要检查一遍 SessionStart 钩子和 pre-commit 的路径 | 把 AIP 装成项目级技能：`--home` 指项目根，钩子得另外重指 | 2026-09-20 |
